...
import MyHospitalReviewScreen from '../screens/HospitalOwner/HospitalInformation/MyHospitalReviewScreen';
...
const HospitalInfoNavigator = props => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="myHospitalReview"
        component={MyHospitalReviewScreen}
      />
    </Stack.Navigator>
  );
};
